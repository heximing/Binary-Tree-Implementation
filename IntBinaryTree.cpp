...
int IntBinaryTree::calculateSubTreeHeight(TreeNode *nodePtr) const
{
	...
	if (nodePtr)
	{
		...
		leftSubTreeHeight = calculateSubTreeHeight(nodePtr->left);
		rightSubTreeHeight = calculateSubTreeHeight(nodePtr->right);
		if (leftSubTreeHeight > rightSubTreeHeight)
		{
			subTreeHeight += leftSubTreeHeight;
		}
		else
		{
			subTreeHeight += rightSubTreeHeight;
		}
	}
	else
	{
